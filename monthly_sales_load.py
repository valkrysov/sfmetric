...
# ==========================================
SFR_FILE = "SFR_August_2026.csv"
CONDO_FILE = "CONDO_August_2026.csv"
TOWNHOUSE_FILE = "TOWNHOMES_August_2026.csv"
...
def enforce_transaction_types(df):

    df = df.copy()

    int_cols = ["days_on_market"]
...
def load_to_postgres(df_all):
    ...
    # 🔥 FIX TYPES FIRST (CRITICAL)
    df_properties = enforce_schema_types(df_properties)
    df_transactions = enforce_transaction_types(df_transactions)
